...
public class ControladorEditarProduccion implements ActionListener {
    ...
    private final Produccion registroProduccion;
    private final Vaca vaca;

    public ControladorEditarProduccion(DialogEdicionProduccion dialogEdicionProduccion, VistaPrincipal vistaPrincipal, VacaDAO vacaDAO, Produccion registroProduccion, Vaca vaca) {
    ...
    public Produccion leerNuevosDatos() {
        return new Produccion(registroProduccion.getFecha(), dialogEdicionProduccion.getLitrosMañana(), dialogEdicionProduccion.getLitrosTarde());
    }
